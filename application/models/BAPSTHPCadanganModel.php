<?php
	class BAPSTHPCadanganModel extends CI_Model
	{
		...
		{
			$this->db->insert('tb_bapsthp_cadangan',$data);
		}

		function Update($id, $data)
		{
			$this->db->where('id', $id);
			$this->db->update('tb_bapsthp_cadangan', $data);
		}

		function Delete($id)
		{
			$this->db->delete('tb_bapsthp_cadangan', array('id' => $id));
		}
