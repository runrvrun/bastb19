<?php
	class HibahPusatModel extends CI_Model
	{
		...
		{
			$this->db->insert('tb_hibah_pusat',$data);
		}

		function Update($id, $data)
		{
			$this->db->where('id', $id);
			$this->db->update('tb_hibah_pusat', $data);
		}

		function Delete($id)
		{
			$this->db->delete('tb_hibah_pusat', array('id' => $id));
			$qry =	"	
					UPDATE tb_alokasi_pusat set id_hibah_pusat = null
		...
		function CheckNoNaskahHibah($no_naskah_hibah)
		{
			...
			$res = $this->db->get('tb_hibah_pusat');
