<?php
	class AlokasiPusatModel extends CI_Model
	{
		...
		function GetAll()
		{
			$qry =	"	
				...
				".(isset($this->session->userdata('logged_in')->id_penyedia_pusat) ? " and pen.id = ".$this->session->userdata('logged_in')->id_penyedia_pusat : "")." 
				GROUP BY 
				...
				k.`nama_kabupaten`, dt.`nilai_barang_detail`, dt.`jumlah_barang_detail`, dt.`regcad`, dt.`dinas`, dt.`no_adendum_1`, 
				dt.`jumlah_barang_rev_1`, dt.`nilai_barang_rev_1`, dt.`no_adendum_2`, dt.`jumlah_barang_rev_2`, dt.`nilai_barang_rev_2`, 
				dt.`nama_file_adendum_1`, dt.`nama_file_adendum_2`, dt.`status_alokasi`, dt.nama_file, pen.`nama_penyedia_pusat`, 
				dt.id_hibah_pusat ORDER BY tahun_anggaran, hd.no_kontrak";
		...
		{
			$qry =	"	
				UPDATE tb_kontrak_detail_pusat SET id_hibah_pusat = $id_hibah
