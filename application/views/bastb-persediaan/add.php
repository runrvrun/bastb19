<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bastb_persediaan/store'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      <input type="hidden" name="id_alokasi_persediaan" value="<?php echo $id_alokasi_persediaan; ?>" />
      ...
      <div class="col_full">
        ...
        <?php }elseif($val['column'] == 'provinsi_penerima'){ ?>
          <input type="hidden" name="id_provinsi_penerima" id="id_provinsi_penerima" value="<?php echo $alokasi_persediaan_pusat->id_provinsi;?>" />                   
          <input type="text" class="form-control" value="<?php echo $alokasi_persediaan_pusat->nama_provinsi;?>" readonly />                   
        ...
        <?php }elseif($val['column'] == 'provinsi_penyerah'){ ?>
          <input type="hidden" name="id_provinsi_penyerah" value="<?php echo $alokasi_persediaan_pusat->id_provinsi;?>"/>
        ...
        <?php }elseif($val['column'] == 'kabupaten_penyerah'){ ?>
          <input type="hidden" name="id_kabupaten_penyerah" value="<?php echo $alokasi_persediaan_pusat->id_kabupaten;?>"/>
