...
<div class="col-md-12 npl npr mb20 dt-buttons">
  ...
  <div class="col-sm-4" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah && isset($alokasi_persediaan_pusat)) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Bastb_persediaan/create?id_alokasi_persediaan=').$alokasi_persediaan_pusat->id; ?>">
  ...
  <div style="float: right; margin-right: -30px;">
    ...
    <div class="col-sm-3" style="width: 110px; height: 110px; text-align: center; padding-top: 15px; border-right: solid; border-right-color: #efefef;">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    success: function (file, response) {      
      <?php if(isset($kontrak_pusat)){ ?>
      window.location="<?php echo base_url('Bastb_persediaan/index?id_alokasi_persediaan='.$alokasi_persediaan_pusat->id); ?>";
      <?php }else{ ?>
        window.location="<?php echo base_url('Bastb_persediaan'); ?>";
      <?php } ?>
    }
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Bastb_persediaan/index_json"); ?>',
        <?php if(isset($alokasi_persediaan_pusat)){ ?>
        "data": {
