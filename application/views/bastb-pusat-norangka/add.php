...
<div class="col_three_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" id="frmrceate" action="<?php echo base_url('Bastb_pusat_norangka/store'); ?>" style="font-color:black;">
      <input type="hidden" name="id_bastb_pusat" value="<?php echo $id_bastb_pusat;?>"/>
      <input type="hidden" name="id_kontrak_pusat" value="<?php echo $id_kontrak_pusat;?>"/>
      <div>
        <div style="float:left"><a href="<?php echo base_url('Bastb_pusat_norangka?id_bastb_pusat='.$id_bastb_pusat) ?>" class="btn btn-warning">&laquo; Kembali</a></div>
...
<script>  
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        ...
        "data": {
           id_alokasi_pusat : '<?php echo $bastb_pusat->id_alokasi_pusat; ?>',
        },
        <?php } ?>
        "dataType": "json",
    },
