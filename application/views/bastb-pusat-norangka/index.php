...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Bastb_pusat_norangka/create?id_bastb_pusat='.$bastb_pusat->id); ?>">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    success: function (file, response) {      
      <?php if(isset($bastb_pusat)){ ?>
      window.location="<?php echo base_url('Norangka/index?id='.$bastb_pusat->id); ?>";
      <?php }else{ ?>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Bastb_pusat_norangka/index_json"); ?>',
        <?php if(isset($bastb_pusat)){ ?>
        "data": {
  ...
  {
    $.ajax({
      url: "<?php echo base_url('Bastb_pusat_norangka/get_json'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id : id_norangka},
  ...
  function removeImage(id_norangka, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('Bastb_pusat_norangka/remove_file'); ?>",
        dataType: 'JSON',
        type: 'GET',
        data: {id_norangka : id_norangka, urutanfile: urutan},
        success: function(data) { 
          <?php if(isset($bastb_pusat)){ ?>
          window.location="<?php echo base_url('Bastb_pusat_norangka/index?id='.$bastb_pusat->id); ?>";
          <?php }else{ ?>
            window.location="<?php echo base_url('Bastb_pusat_norangka'); ?>";
          <?php } ?>
        },
        error: function(jqXHR, textStatus, errorThrown) {             
          <?php if(isset($bastb_pusat)){ ?>
