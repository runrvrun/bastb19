...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-4" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-4" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('BAPSTHPReguler/Add'); ?>">
        <img src="<?php echo base_url('assets/ico/file_icon.png'); ?>" width="50px" />
      </a><br>
      <span style="font-size:10px; font-weight: bold;">Input Data BAP-STHP Reguler</span>
    </div>
    <?php } ?>
    <div class="col-sm-4" style="padding-top: 10px; text-align: center; ">
    ...
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure to delete No No BAP-STHP <b><i class="title"></i></b> ?
            </div>
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("BAPSTHPReguler/Test"); ?>',
    ...
    success: function (file, response) {
          ...
          // }
          // alert(response);
          window.location="<?php echo base_url('BAPSTHPReguler'); ?>";
    },
  }
  ...
  $("#ExportReporttoExcel").on("click", function() {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo site_url("BAPSTHPReguler/doExport"); ?>',
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("BAPSTHPReguler/AjaxGetAllData"); ?>',
        "data": function(d) {
  ...
  {
    $.ajax({
      url: "<?php echo base_url('BAPSTHPReguler/GetBAPSTHP'); ?>",
      dataType: 'JSON',
      type: 'GET',
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='../upload/bapsthp_reguler/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
  ...
  function removeImage(id_bapsthp, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('BAPSTHPReguler/RemoveImage'); ?>",
        dataType: 'JSON',
        type: 'GET',
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'pdf' || file_format == 'PDF'){
              ...
              content += "<div class='mySlides'><div class='numbertext'> "+(i+1)+" / "+obj.length+" </div><img id='zoom_"+i+"' src='../upload/bapsthp_reguler/"+obj[i]+"' height='300' /><div class='text'>"+obj[i].substring(10)+"&nbsp;&nbsp;&nbsp;<a class='btn btn-xs btn-primary btn-sm' href='../upload/bapsthp_reguler/"+obj[i]+"' download><i class='glyphicon glyphicon-save-file'></i></a></div></div>";
            }
          ...
          for(var i=0;i<obj.length;i++)
          {
            var file_format = obj[i].substr(obj[i].length - 3); 
            if(file_format == 'pdf' || file_format == 'PDF'){
              PDFObject.embed("../upload/bapsthp_reguler/"+obj[i], "#embedPDF_"+i);
