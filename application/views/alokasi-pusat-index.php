...
<script>
  ...
  $("#ExportReporttoExcel").on("click", function() {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo site_url("AlokasiPusat/doExport"); ?>',
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("AlokasiPusat/AjaxGetAllData"); ?>',
        "data": function(d) {
  ...
  {
    $.ajax({
      url: "<?php echo base_url('AlokasiPusat/GetData'); ?>",
      dataType: 'JSON',
      type: 'GET',
      ...
      success: function(data) {
        ...
        $('#prev_penyedia').html(data['nama_penyedia_pusat']);
