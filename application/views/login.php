  ...
  <style>
    * {
    ...
    #col1 {
      ...
      min-height: 100%;
      position: relative;
      background: url('<?php echo base_url("assets/img/login_bg.jpg"); ?>') no-repeat;
      ...
      <div class="center">
        <form method="post" action="<?php echo base_url('Auth/doLogin'); ?>">
          <div class="form-group">
            ...
            <input type="text" name="Username" placeholder="Masukkan Email yang Terdaftar" autofocus>
          </div>
          <div class="form-group">
            ...
            <select name="tahun_pengadaan">
              ...
              <?php 
                foreach($tahun_pengadaan as $tahun){
                  echo "<option value='".$tahun->tahun_pengadaan."' ".($tahun->tahun_pengadaan == date('Y') ? 'selected' : '').">".$tahun->tahun_pengadaan."</option>";
                }
              ?>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="right">
              <a href="<?php echo base_url('LupaPassword'); ?>">Lupa Password?</a>
            </div>
            <div class="clearfix">
            </div>
          </div>
