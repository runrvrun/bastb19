  ...
  <div class="btn-group" role="group" aria-label="Basic example">
    ...
    <div style="float:left; padding: 10px; width:25%">
      <label>PENYEDIA</label>
        <select name="id_penyedia_pusat" id="id_penyedia_pusat" class="form-control" multiple="multiple" required>
        <?php 
          foreach($penyedia as $peny){
            echo "<option value=".$peny->id.">".$peny->nama_penyedia_pusat."</option>";
          }
        ?>
        </select>
    </div>
...
<!-- download pdf link -->
<a id="anchorID" href="../upload/report/LaporanSummaryPusat.pdf" target="_blank"></a>
<!-- <a id="anchorID" href="../upload/report/LaporanSummaryPusat.pdf" download></a> -->
<!--  -->
...
<script>
  ...
  $('#btnProses').on('click', function() {
    $.ajax({
      url: "<?php echo base_url('LaporanSummaryPusat/GetReportData'); ?>",
      dataType: 'JSON',
      type: 'POST',
      data: { tahun_anggaran : $("#tahun_anggaran").val() , list_id_provinsi : $("#id_provinsi").val(), list_id_kabupaten : $("#id_kabupaten").val(), list_id_penyedia : $("#id_penyedia_pusat").val() },
      success: function(data) {
  ...
  $('#ExportReporttoPDF').on('click', function() {
    $.ajax({
      url: "<?php echo base_url('LaporanSummaryPusat/ExportPDF'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: { tahun_anggaran : $("#tahun_anggaran").val() , list_id_provinsi : $("#id_provinsi").val(), list_id_kabupaten : $("#id_kabupaten").val(), list_id_penyedia : $("#id_penyedia_pusat").val() },
      success: function(data) {
