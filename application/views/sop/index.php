...
<div class="col-md-12 npl npr mb20 dt-buttons">
  ...
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    <?php if($bolehtambah && $this->session->userdata('logged_in')->role_pengguna=='ADMIN PUSAT') { ?> 
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      ...
      <span style="font-size:10px; font-weight: bold;">Input SOP</span>
    </div>
    <?php } ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
...
<div class="modal fade" id="upload-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            <div class="modal-header">
                Upload File Untuk SOP <b><i class="title"></i></b>
            </div>
            <div class="modal-body">
              <div class="col_full">
                <label>UPLOAD FOTO/DOKUMEN SOP</label>
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("Sop/upload_file"); ?>',
    ...
    success: function (file, response) {      
      ...
      window.location="<?php echo base_url('Sop/index?id='.$kontrak_pusat->id); ?>";
      <?php }else{ ?>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Sop/index_json"); ?>',
        "dataType": "json",
    },
  ...
  function showUploadedFiles(id_sop)
  {
    $.ajax({
      url: "<?php echo base_url('Sop/get_json'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id : id_sop},
  ...
  function removeImage(id_sop, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('Sop/remove_file'); ?>",
        dataType: 'JSON',
        type: 'GET',
