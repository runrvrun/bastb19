...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-4" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-4" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('KontrakPusat/Add'); ?>">
    ...
    <?php 
      for($i=0; $i<count($kontrak_pusat); $i++){
        echo "<tr>
                ...
                <td nowrap>";
    ?>
              <a class="btn btn-xs btn-warning btn-sm" href="<?php echo base_url('KontrakPusat/ShowDetail?id=').$kontrak_pusat[$i]->id; ?>"><i class="glyphicon glyphicon-plus"></i></a>
              ...
              <a class="btn btn-xs btn-primary btn-sm" href="<?php echo base_url('KontrakPusat/Edit?id=').$kontrak_pusat[$i]->id; ?>"><i class="glyphicon glyphicon-pencil"></i></a>
              <a class="btn btn-xs btn-danger btn-sm" data-href="<?php echo base_url('KontrakPusat/doDelete?id=').$kontrak_pusat[$i]->id; ?>" data-toggle="modal" data-record-title="<?php echo $kontrak_pusat[$i]->no_kontrak; ?>" data-target="#confirm-delete"><i class="glyphicon glyphicon-trash"></i></a>
...
<!--  <div class="img-zoom-container">
  <img id="myimage" src="<?php echo base_url('../upload/kontrak_pusat/frenchie.jpg'); ?>" width="250px" />
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("KontrakPusat/AjaxGetAllData"); ?>',
        "dataType": "json",
    },
  ...
  {
    $.ajax({
      url: "<?php echo base_url('KontrakPusat/GetKontrak'); ?>",
      dataType: 'JSON',
      type: 'GET',
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='../upload/kontrak_pusat/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
  ...
  function removeImage(id_kontrak, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('KontrakPusat/RemoveImage'); ?>",
        dataType: 'JSON',
        type: 'GET',
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'pdf' || file_format == 'PDF'){
              ...
              content += "<div class='mySlides'><div class='numbertext'> "+(i+1)+" / "+obj.length+" </div><img id='zoom_"+i+"' src='../upload/kontrak_pusat/"+obj[i]+"' height='300' /><div class='text'>"+obj[i].substring(10)+"&nbsp;&nbsp;&nbsp;<a class='btn btn-xs btn-primary btn-sm' href='../upload/kontrak_pusat/"+obj[i]+"' download><i class='glyphicon glyphicon-save-file'></i></a></div></div>";
            }
          ...
          for(var i=0;i<obj.length;i++)
          {
            var file_format = obj[i].substr(obj[i].length - 3); 
            if(file_format == 'pdf' || file_format == 'PDF'){
              PDFObject.embed("../upload/kontrak_pusat/"+obj[i], "#embedPDF_"+i);
