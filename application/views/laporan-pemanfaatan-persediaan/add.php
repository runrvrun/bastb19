<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Laporan_pemanfaatan_persediaan/store'); ?>" style="font-color:black;" enctype="multipart/form-data">
      <?php if(isset($id_bastb_persediaan)){ ?>
      ...
      <?php if(isset($id_bastb_persediaan)){ ?>        
        <a href="<?php echo base_url('Laporan_pemanfaatan_persediaan/index?id_bastb_persediaan=').$id_bastb_persediaan; ?>">
      <?php } ?>
