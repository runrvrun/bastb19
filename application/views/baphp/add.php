...
<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Baphp/store'); ?>" style="font-color:black;" enctype="multipart/form-data">
      ...
      <div class="col_full">
        ...
        <?php }elseif($val['column'] == 'provinsi_penerima'){ ?>
          <input type="hidden" name="id_provinsi_penerima" id="<?php echo $val['column'];?>" value=<?php echo $alokasi_pusat->id_provinsi;?> />                   
          <input type="text" name="provinsi_penerima" class="form-control" value="<?php echo $alokasi_pusat->nama_provinsi;?>" readonly />                   
        <?php }elseif($val['column'] == 'kabupaten_penerima'){ ?>
          <input type="hidden" name="id_kabupaten_penerima" id="<?php echo $val['column'];?>" value="<?php echo $alokasi_pusat->id_kabupaten;?>" />                   
          <input type="text" name="kabupaten_penerima" class="form-control" value="<?php echo $alokasi_pusat->nama_kabupaten;?>" readonly />                   
        ...
        <?php }elseif($val['column'] == 'tanggal_batitip') { ?>
          ...
          <input type="text" class="input-sm form-control" name="tanggal_batitip" value="" autocomplete="off" />
          <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
          </div>
        <?php }else{ ?>
