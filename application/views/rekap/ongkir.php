...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php echo base_url('Rekap/data_ongkir?id_kontrak_pusat='.$kontrak_pusat->id);?>">Data Ongkir</a></li>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Rekap/data_ongkir_json"); ?>',
        "data": {
