...
<ul class="nav nav-tabs">
  <li><a href="<?php echo base_url('Rekap_kontrak_pusat/rekap?id_kontrak_pusat='.$kontrak_pusat->id);?>">Rekap Data</a></li>
  <li class="active"><a href="<?php echo base_url('Rekap_kontrak_pusat/pemanfaatan?id_kontrak_pusat='.$kontrak_pusat->id);?>">Pemanfaatan</a></li>
</ul>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
      "type": "POST",
        "url": '<?php echo base_url("Rekap_kontrak_pusat/pemanfaatan_json"); ?>',
        "data": {
