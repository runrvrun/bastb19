...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php echo base_url('Rekap/baphp_persediaan?id_kontrak_pusat='.$kontrak_pusat->id);?>">BAPHP Persediaan</a></li>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Rekap/baphp_persediaan_json"); ?>',
        "data": {
