...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php echo base_url('Rekap/baphp_reguler?id_kontrak_pusat='.$kontrak_pusat->id);?>">BAPHP Reguler</a></li>
  ...
  <li><a href="<?php echo base_url('Rekap/hibah?id_kontrak_pusat='.$kontrak_pusat->id);?>">Hibah</a></li>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Rekap/baphp_reguler_json"); ?>',
        "data": {
