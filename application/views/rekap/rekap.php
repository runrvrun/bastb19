...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="downloaddoc?id_kontrak_pusat=<?php echo $kontrak_pusat->id;?>">
...
<ul class="nav nav-tabs">
  <li class="active"><a href="<?php echo base_url('Rekap_kontrak_pusat/rekap?id_kontrak_pusat='.$kontrak_pusat->id);?>">Rekap Data</a></li>
  <li><a href="<?php echo base_url('Rekap_kontrak_pusat/pemanfaatan?id_kontrak_pusat='.$kontrak_pusat->id);?>">Pemanfaatan</a></li>
</ul>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Rekap_kontrak_pusat/rekap_json"); ?>',
        "data": {
