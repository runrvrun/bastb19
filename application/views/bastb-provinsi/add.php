<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bastb_provinsi/store'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      ...
      <div class="col_full">
        ...
        <?php }elseif($val['column'] == 'provinsi_penerima'){ ?>
          <input type="hidden" name="id_provinsi_penerima" id="id_provinsi_penerima" value="<?php echo $alokasi_provinsi->id_provinsi;?>" />                   
          <input type="text" class="form-control" value="<?php echo $alokasi_provinsi->nama_provinsi;?>" readonly />                   
        <?php }elseif($val['column'] == 'kabupaten_penerima'){ ?>
          ...
          <?php }else{ ?>
            <select id="id_kabupaten_penerima" class="form-control js-example-basic-single">
            </select>          
          <?php } ?>
        ...
        <?php }elseif($val['column'] == 'harga_satuan'){ ?>
          <input type="text" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo number_format($alokasi_provinsi->harga_satuan_rev,0);?>" disabled />                   
