...
<div class="col_three_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" id="frmrceate" action="<?php echo base_url('Bastb_provinsi_norangka/store'); ?>" style="font-color:black;">
      ...
      <div>
        <div style="float:left"><a href="<?php echo base_url('Bastb_provinsi_norangka?id_bastb_provinsi='.$id_bastb_provinsi) ?>" class="btn btn-warning">&laquo; Kembali</a></div>
...
<script>  
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Baphp_provinsi_norangka/index_unselbastb_json"); ?>',
        <?php if(isset($bastb_provinsi)){ ?>
        "data": {
           id_alokasi_provinsi : '<?php echo $bastb_provinsi->id_alokasi_provinsi; ?>',
        },
        <?php } ?>
        "dataType": "json",
    },
