<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bastb_provinsi_norangka/store'); ?>" style="font-color:black;">
      ...
      <div class="col_full nobottommargin">
        <a href="<?php echo base_url('Bastb_provinsi_norangka/index?id_bastb_provinsi='.$id_bastb_provinsi); ?>">
