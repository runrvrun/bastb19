<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bart/store'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;">
      ...
      <div class="col_full">
        ...
        <?php if($val['column'] == 'tanggal') { ?>
          ...
          <input type="text" class="input-sm form-control" autocomplete="off" name="tanggal" required />
        ...
        <?php }elseif($val['column'] == 'lokasi_pemeriksaan') { ?>
          <textarea name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" rows=5 class="form-control"></textarea>
        <?php }else{ ?>
      ...
      <div class="col_full nobottommargin">
        <a href="<?php echo base_url('Bart/index?id_kontrak_pusat='.$id_kontrak_pusat); ?>">
