...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade in active" id="unit" role="tabpanel" aria-labelledby="unit-tab">
      <div style="height: 750px; padding: 20px; border: 1px solid; margin-top: 20px; border-radius: 20px; box-shadow: 10px 10px 5px grey;">
      <h3>Unit</h3>
...
<script>
  ...
  var tableUnit = $('#tableUnit').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("LaporanKontrakProvinsi/AjaxGetDataUnit"); ?>',
        "dataType": "json",
        "data":function(data) {
              data.barang = $('#list_nama_barang').val();
              data.provinsi = $('#id_provinsi').val();
              data.kabupaten = $('#id_kabupaten').val();
        },
    },
  ...
  var tableNilai = $('#tableNilai').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("LaporanKontrakProvinsi/AjaxGetDataNilai"); ?>',
        "dataType": "json",
        "data":function(data) {
              data.barang = $('#list_nama_barang').val();
              data.provinsi = $('#id_provinsi').val();
