...
<div id="headerKontrak" style="width:100%; text-align:center; border-style: solid; mergin-bottom: 40px">
  ...
  <h4><?php echo date('d M Y', strtotime($kontrak_provinsi->periode_mulai))." - ".date('d M Y', strtotime($kontrak_provinsi->periode_selesai)); ?></h4>
...
<div class="col-md-12 npl npr mb20 dt-buttons">
  ...
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('KontrakProvinsi/AddDetail?id=').$kontrak_provinsi->id; ?>">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("KontrakProvinsi/UploadFileDetail"); ?>',
    ...
    success: function (file, response) {
          ...
          window.location="<?php echo base_url('KontrakProvinsi/ShowDetail?id='.$kontrak_provinsi->id); ?>";
    },
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("KontrakProvinsi/AjaxGetAllDataDetail"); ?>',
        "data": {
  ...
  {
    $.ajax({
      url: "<?php echo base_url('KontrakProvinsi/GetKontrakDetail'); ?>",
      dataType: 'JSON',
      type: 'GET',
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='../../upload/kontrak_provinsi_detail/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
  ...
  function removeImage(id_kontrak_detail, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('KontrakProvinsi/RemoveFileDetail'); ?>",
        dataType: 'JSON',
        type: 'GET',
