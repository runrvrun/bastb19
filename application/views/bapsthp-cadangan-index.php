...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-4" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-4" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('BAPSTHPCadangan/Add'); ?>">
        <img src="<?php echo base_url('assets/ico/file_icon.png'); ?>" width="50px" />
      </a><br>
      <span style="font-size:10px; font-weight: bold;">Input Data BAP-STHP Cadangan</span>
    </div>
    <?php } ?>
    <div class="col-sm-4" style="padding-top: 10px; text-align: center; ">
...
<div style="margin-top: 150px; ">
  ...
  <thead>
    <tr>
      ...
      <td>
        <select class="search-input-select" data-column="26">
          <option value=""></option>
    ...
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure to delete No BAP-STHP <b><i class="title"></i></b> ?
            </div>
...
<div class="modal fade" id="upload-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            <div class="modal-header">
                Upload File Untuk No BAP-STHP <b><i class="title"></i></b>
            </div>
            <div class="modal-body">
              <div class="col_full">
            ...
            <div class="modal-body">
              ...
              <div class="row custom">
                  ...
                  <div class="col-md-3">
                      ...
                      <label class="form-check-label" for="chkShowTitikSerah">Titik Serah</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="3" id="chkNamaWilayah" checked>
                      <label class="form-check-label" for="chkNamaWilayah">Nama Wilayah</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="4" id="chkNoBAPSTHP" checked>
                      <label class="form-check-label" for="chkNoBAPSTHP">No. BAP-STHP</label>
                  </div>
              ...
              <div class="row custom">
                  ...
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="5" id="chkTanggal" checked>
                      <label class="form-check-label" for="chkTanggal">Tanggal</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="6" id="chkPihakPenyerah" checked>
                      <label class="form-check-label" for="chkPihakPenyerah">Pihak yang Menyerahkan</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="7" id="chkNamaPenyerah" checked>
                      <label class="form-check-label" for="chkNamaPenyerah">Nama yang Menyerahkan</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="8" id="chkJabatanPenyerah" checked>
              ...
              <div class="row custom">
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="9" id="chkTelpPenyerah" checked>
                      <label class="form-check-label" for="chkTelpPenyerah">Telp yang Menyerahkan</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="10" id="chkAlamatPenyerah" checked>
                      <label class="form-check-label" for="chkAlamatPenyerah">Alamat yang Menyerahkan</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="11" id="chkProvPenyerah" checked>
                      <label class="form-check-label" for="chkProvPenyerah">Provinsi yang Menyerahkan</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="12" id="chkKabPenyerah" checked>
                      <label class="form-check-label" for="chkKabPenyerah">Kabupaten/Kota yang Menyerahkan</label>
                  </div>
              ...
              <div class="row custom">
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="13" id="chkPihakPenerima" checked>
                      <label class="form-check-label" for="chkPihakPenerima">Pihak yang Menerima</label>
                  </div>
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="14" id="chkNamaPenerima" checked>
                      <label class="form-check-label" for="chkNamaPenerima">Nama yang Menerima</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="15" id="chkJabatanPenerima" checked>
                      <label class="form-check-label" for="chkJabatanPenerima">Jabatan yang Menerima</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="16" id="chkTelpPenerima" checked>
              ...
              <div class="row custom">
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="17" id="chkAlamatPenerima" checked>
                      <label class="form-check-label" for="chkAlamatPenerima">Alamat yang Menerima</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="18" id="chkProvPenerima" checked>
                      <label class="form-check-label" for="chkProvPenerima">Provinsi yang Menerima</label>
                  </div>
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="19" id="chkKabPenerima" checked>
                      <label class="form-check-label" for="chkKabPenerima">Kabupaten/Kota yang Menerima</label>
                  </div>
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="20" id="chkNoKontrak" checked>
              ...
              <div class="row custom">
                  ...
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="21" id="chkNamaBarang" checked>
                      <label class="form-check-label" for="chkNamaBarang">Nama Barang</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="22" id="chkMerk" checked>
                      <label class="form-check-label" for="chkMerk">Merk</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="23" id="chkJumlah" checked>
                      <label class="form-check-label" for="chkJumlah">Jumlah</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="24" id="chkNilai" checked>
              ...
              <div class="row custom">
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="25" id="chkNamaMengetahui" checked>
                      <label class="form-check-label" for="chkNamaMengetahui">Nama Mengetahui</label>
                  </div>                
                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="26" id="chkJabatanMengetahui" checked>
                      <label class="form-check-label" for="chkJabatanMengetahui">Jabatan Mengetahui</label>
                  </div>

                  <div class="col-md-3">
                      <input class="form-check-input" name="show" type="checkbox" value="27" id="chkKetFoto" checked>
...
<div class="modal fade" id="preview-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="color:black; width: 95%; ">
        <div class="modal-content" style="height: auto;">
            ...
            <div class="modal-header">
                Preview Data BAP-STHP Cadangan
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  <table class="table table-striped" style="display: block; height: 500px; overflow-y: scroll;">
                    ...
                    <tr>
                      <td>Titik Serah</td>
                      <td>:</td>
                      <td id="prev_titik_serah"></td>
                    </tr>
                    <tr>
                      <td>Nama Wilayah</td>
                      <td>:</td>
                      <td id="prev_nama_wilayah"></td>
                    </tr>
                    <tr>
                      <td>No BAP-STHP</td>
                      <td>:</td>
                      <td id="prev_no_bapsthp"></td>
                    </tr>
                    <tr>
                      <td>Tanggal</td>
                      <td>:</td>
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("BAPSTHPCadangan/Test"); ?>',
    ...
    init: function() {
      ...
      this.on("sendingmultiple", function(data, xhr, formData) {
          formData.append("id_bapsthp", jQuery("#id_row").val());
      });
    },
    success: function (file, response) {
          ...
          // }
          // alert(response);
          window.location="<?php echo base_url('BAPSTHPCadangan'); ?>";
    },
  }
  ...
  $("#ExportReporttoExcel").on("click", function() {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo site_url("BAPSTHPCadangan/doExport"); ?>',
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("BAPSTHPCadangan/AjaxGetAllData"); ?>',
        "data": function(d) {
  ...
  $("#show-column-save-btn").click(function () {
      ...
      if($("#chkStandar").prop('checked') == true){
        ...
        $("#chkKabPenyerah").prop('checked', false);

        $("#chkPihakPenerima").prop('checked', false);
        ...
        $("#chkKabPenerima").prop('checked', false);
  ...
  function showUploadedFiles(id_bapsthp)
  {
    $.ajax({
      url: "<?php echo base_url('BAPSTHPCadangan/GetBAPSTHP'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id_bapsthp : id_bapsthp},
      success: function(data) {
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='../upload/bapsthp_cadangan/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
            content += "<td><a class='btn btn-s btn-danger' onclick='removeImage("+id_bapsthp+", "+i+")'><i class='glyphicon glyphicon-trash'></i></a></td>";
            content += "</tr>";
          }
  ...
  function removeImage(id_bapsthp, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('BAPSTHPCadangan/RemoveImage'); ?>",
        dataType: 'JSON',
        type: 'GET',
        data: {id_bapsthp : id_bapsthp, urutanfile: urutan},
        success: function(data) {
  ...
  function LoadData(id_bapsthp)
  {
    $.ajax({
      ...
      success: function(data) {
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'pdf' || file_format == 'PDF'){
              ...
              content += "<div class='mySlides'><div class='numbertext'> "+(i+1)+" / "+obj.length+" </div><img id='zoom_"+i+"' src='../upload/bapsthp_cadangan/"+obj[i]+"' height='300' /><div class='text'>"+obj[i].substring(10)+"&nbsp;&nbsp;&nbsp;<a class='btn btn-xs btn-primary btn-sm' href='../upload/bapsthp_cadangan/"+obj[i]+"' download><i class='glyphicon glyphicon-save-file'></i></a></div></div>";
            }
          ...
          for(var i=0;i<obj.length;i++)
          {
            var file_format = obj[i].substr(obj[i].length - 3); 
            if(file_format == 'pdf' || file_format == 'PDF'){
              PDFObject.embed("../upload/bapsthp_cadangan/"+obj[i], "#embedPDF_"+i);
        ...
        $('#prev_titik_serah').html(data['titik_serah']);
        $('#prev_nama_wilayah').html(data['nama_wilayah']);
        $('#prev_no_bapsthp').html(data['no_bapsthp']);
