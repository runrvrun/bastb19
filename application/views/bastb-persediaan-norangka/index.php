...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Bastb_persediaan_norangka/create?id_bastb_persediaan='.$bastb_persediaan->id); ?>">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    success: function (file, response) {      
      <?php if(isset($bastb_persediaan)){ ?>
      window.location="<?php echo base_url('Bastb_persediaan_norangka/index?id='.$bastb_persediaan->id); ?>";
      <?php }else{ ?>
        window.location="<?php echo base_url('Bastb_persediaan_norangka'); ?>";
      <?php } ?>
    }
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Bastb_persediaan_norangka/index_json"); ?>',
        <?php if(isset($bastb_persediaan)){ ?>
        "data": {
  ...
  {
    $.ajax({
      url: "<?php echo base_url('Bastb_persediaan_norangka/get_json'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id : id_norangka},
  ...
  function removeImage(id_norangka, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('Bastb_persediaan_norangka/remove_file'); ?>",
        dataType: 'JSON',
        type: 'GET',
