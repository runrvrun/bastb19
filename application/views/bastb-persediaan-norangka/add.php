...
<div class="col_three_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" id="frmrceate" action="<?php echo base_url('Bastb_persediaan_norangka/store'); ?>" style="font-color:black;">
      <input type="hidden" name="id_bastb_persediaan" value="<?php echo $id_bastb_persediaan;?>"/>
      <input type="hidden" name="id_kontrak_pusat" value="<?php echo $id_kontrak_pusat;?>"/>
      <div>
        <div style="float:left"><a href="<?php echo base_url('Bastb_persediaan_norangka?id_bastb_persediaan='.$id_bastb_persediaan) ?>" class="btn btn-warning">&laquo; Kembali</a></div>
...
<script>  
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Norangka/index_unselbastb_json"); ?>',
        <?php if(isset($bastb_persediaan)){ ?>
        "data": {
          id_alokasi_persediaan_pusat : '<?php echo $bastb_persediaan->id_alokasi_persediaan_pusat; ?>',
        },
        <?php } ?>
        "dataType": "json",
    },
