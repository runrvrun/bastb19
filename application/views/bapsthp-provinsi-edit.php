...
<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('BAPSTHPProvinsi/doEdit'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?php echo $bapsthp_provinsi->id; ?>" />
      <h3>INFORMASI DOKUMEN</h3>
      <hr>
      <div class="col_full">
        <label>TAHUN ANGGARAN</label>
        <input type="text" name="tahun_anggaran" id="tahun_anggaran" class="form-control" value="<?php echo $bapsthp_provinsi->tahun_anggaran; ?>" readonly/>
      </div>
      <div class="col_full">
        ...
        <select name="titik_serah" id="titik_serah" class="form-control js-example-basic-single" onchange="changeNamaWilayah(this.value);" required>
          <option value="PROVINSI" <?php echo($bapsthp_provinsi->titik_serah == 'PROVINSI' ? 'selected' : ''); ?> >PROVINSI</option>
          <option value="KABUPATEN/KOTA" <?php echo($bapsthp_provinsi->titik_serah == 'KABUPATEN/KOTA' ? 'selected' : ''); ?> >KABUPATEN/KOTA</option>
          <option value="KODIM/KOREM" <?php echo($bapsthp_provinsi->titik_serah == 'KODIM/KOREM' ? 'selected' : ''); ?> >KODIM/KOREM</option>
          <option value="PUSAT" <?php echo($bapsthp_provinsi->titik_serah == 'PUSAT' ? 'selected' : ''); ?> >PUSAT</option>
        </select>
      </div>
      <div class="col_full">
        ...
        <input type="text" name="txt_nama_wilayah" id="txt_nama_wilayah" class="form-control" required value="<?php echo $bapsthp_provinsi->nama_wilayah; ?>" />
      </div>
      <div class="col_full">
        <label>NO BAP-STHP</label>
        <input type="text" name="no_bapsthp" id="no_bapsthp" class="form-control" required value="<?php echo $bapsthp_provinsi->no_bapsthp; ?>" />
      </div>
      <div class="col_full">
        <label>TANGGAL BAP-STHP</label>
        <div class="input-daterange input-group" id="datepicker">
          <input type="text" class="input-sm form-control" name="tanggal" id="tanggal" required value="<?php echo date('d-m-Y', strtotime($bapsthp_provinsi->tanggal)); ?>" />
      ...
      <div class="col_full">
        ...
        <?php 
          ...
          //   echo "<option value=".$penyedia->id."  ".($penyedia->id == $bapsthp_provinsi->id_penyerah ? 'selected' : '')." >".$penyedia->nama_penyedia_provinsi."</option>";
          // }
        ?>
        </select>
      </div>
      <div class="col_full">
        <label>NAMA</label>
        <input type="text" name="nama_penyerah" id="nama_penyerah" class="form-control" required value="<?php echo $bapsthp_provinsi->nama_penyerah; ?>" />
      </div>
      <div class="col_full">
        <label>JABATAN</label>
        <input type="text" name="jabatan_penyerah" id="jabatan_penyerah" class="form-control" required value="<?php echo $bapsthp_provinsi->jabatan_penyerah; ?>" />
      </div>
      <div class="col_full">
        <label>NO TELEPON</label>
        <input type="text" name="notelp_penyerah" id="notelp_penyerah" class="form-control" required value="<?php echo $bapsthp_provinsi->notelp_penyerah; ?>" />
      </div>
      <div class="col_full">
        <label>ALAMAT</label>
        <textarea name="alamat_penyerah" id="alamat_penyerah" class="form-control" required><?php echo $bapsthp_provinsi->alamat_penyerah; ?></textarea>
      </div>
      <div class="col_full">
        ...
        <?php 
          foreach($provinsi as $prov){
            echo "<option value=".$prov->id." ".($prov->id == $bapsthp_provinsi->id_provinsi_penyerah ? 'selected' : '')." >".$prov->nama_provinsi."</option>";
          }
        ?>
        </select>
      </div>
      ...
      <div class="col_full">
        ...
        <input type="text" name="pihak_penerima" id="pihak_penerima" class="form-control" required value="<?php echo $bapsthp_provinsi->pihak_penerima; ?>" />
      </div>
      <div class="col_full">
        <label>NAMA</label>
        <input type="text" name="nama_penerima" id="nama_penerima" class="form-control" required value="<?php echo $bapsthp_provinsi->nama_penerima; ?>" />
      </div>
      <div class="col_full">
        <label>JABATAN</label>
        <input type="text" name="jabatan_penerima" id="jabatan_penerima" class="form-control" required value="<?php echo $bapsthp_provinsi->jabatan_penerima; ?>" />
      </div>
      <div class="col_full">
        <label>NO TELEPON</label>
        <input type="text" name="notelp_penerima" id="notelp_penerima" class="form-control" required value="<?php echo $bapsthp_provinsi->notelp_penerima; ?>" />
      </div>
      <div class="col_full">
        <label>ALAMAT</label>
        <textarea name="alamat_penerima" id="alamat_penerima" class="form-control" required><?php echo $bapsthp_provinsi->alamat_penerima; ?></textarea>
      </div>
      <div class="col_full">
        <label>PROVINSI</label>
        ...
        <?php 
          foreach($provinsi as $prov){
            echo "<option value=".$prov->id." ".($prov->id == $bapsthp_provinsi->id_provinsi_penerima ? 'selected' : '').">".$prov->nama_provinsi."</option>";
          }
        ?>
        </select>
      </div>
      ...
      <div class="col_full">
        ...
        <input type="text" name="jumlah_barang" id="jumlah_barang" class="form-control numberFilter" required value="<?php echo $bapsthp_provinsi->jumlah_barang; ?>" />
      </div>
      <div class="col_full">
        <label>NILAI BARANG (RP)</label>
        <input type="text" name="nilai_barang" id="nilai_barang" class="form-control numberFilter" required value="<?php echo $bapsthp_provinsi->nilai_barang; ?>" />
      </div>
      <div class="col_full">
        <label>HARGA SATUAN (RP)</label>
        <input type="text" name="harga_satuan" id="harga_satuan" class="form-control" readonly value="<?php echo ($bapsthp_provinsi->nilai_barang / $bapsthp_provinsi->jumlah_barang); ?>" />
      </div>
      <hr>
      ...
      <div class="col_full">
        <label>NAMA</label>
        <input type="text" name="nama_mengetahui" id="nama_mengetahui" class="form-control" required value="<?php echo $bapsthp_provinsi->nama_mengetahui; ?>" />
      </div>
      <div class="col_full">
        <label>JABATAN</label>
        <input type="text" name="jabatan_mengetahui" id="jabatan_mengetahui" class="form-control" required value="<?php echo $bapsthp_provinsi->jabatan_mengetahui; ?>" />
      </div>
...
<script> 
    ...
    if(val == 'PROVINSI'){
      $.ajax({
        ...
        success: function(data) {
            ...
            {
              if(data[i]["nama_provinsi"] == '<?php echo $bapsthp_provinsi->nama_wilayah; ?>'){
                $('#nama_wilayah').append(
      ...
      $.ajax({
        ...
        success: function(data) {
            ...
            for(var i=0;i<data.length;i++)
            {
              if(data[i]["nama_kabupaten"] == '<?php echo $bapsthp_provinsi->nama_wilayah; ?>'){
                $('#nama_wilayah').append(
      ...
      $.ajax({
        ...
        success: function(data) {
            ...
            for(var i=0;i<data.length;i++)
            {
              if(data[i]["nama_kodim_korem"] == '<?php echo $bapsthp_provinsi->nama_wilayah; ?>'){
                $('#nama_wilayah').append(
  ...
  function LoadKabupatenPenyerah()
  {
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["id"] == '<?php echo $bapsthp_provinsi->id_kabupaten_penyerah; ?>'){
  ...
  function LoadKabupatenPenerima()
  {
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["id"] == '<?php echo $bapsthp_provinsi->id_kabupaten_penerima; ?>'){
    ...
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            ...
            if(data[i]["id_penyerah"] == '<?php echo $bapsthp_provinsi->id_penyerah; ?>'){
              $('#id_penyerah').append(
  ...
  $(document).ready(function() {
    LoadBarang();
    changeNamaWilayah('<?php echo $bapsthp_provinsi->titik_serah; ?>');
  ...
  function LoadBarang(){
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["nama_barang"] == '<?php echo $bapsthp_provinsi->nama_barang; ?>'){
              $('#nama_barang').append(
  ...
  function LoadMerk(){
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["merk"] == '<?php echo $bapsthp_provinsi->merk; ?>'){
              $('#merk').append(
  ...
  function LoadKontrak(){
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["no_kontrak"] == '<?php echo $bapsthp_provinsi->no_kontrak; ?>'){
              $('#no_kontrak').append(
