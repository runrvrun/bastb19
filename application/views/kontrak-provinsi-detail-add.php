<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('KontrakProvinsi/doAddDetail'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      <input type="hidden" name="id_kontrak_provinsi" value="<?php echo $kontrak_provinsi->id; ?>" />
      <h3>TAMBAH DATA KONTRAK DETAIL TP PROVINSI</h3>
      <hr>
      <div class="col_full">
