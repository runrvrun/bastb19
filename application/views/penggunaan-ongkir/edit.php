<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Penggunaan_ongkir/update'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;">
      ...
      <div class="col_full nobottommargin">
        <a href="<?php echo base_url('Penggunaan_ongkir/index?id_baphp='.$ongkir->id_baphp); ?>">
