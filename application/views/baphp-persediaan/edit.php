...
<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Baphp_persediaan/update'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?php echo $baphp_persediaan->id; ?>" />
      <input type="hidden" name="id_alokasi_persediaan_pusat" value="<?php echo $alokasi_persediaan_pusat->id; ?>" />
      ...
      <div class="col_full">
        ...
        <?php if($val['column'] == 'titik_serah') { ?>
          ...
          <option value="PROVINSI" <?php echo ($baphp_persediaan->titik_serah == 'PROVINSI')? 'selected':'';?>>PROVINSI</option>
          <option value="KABUPATEN/KOTA" <?php echo ($baphp_persediaan->titik_serah == 'KABUPATEN/KOTA')? 'selected':'';?>>KABUPATEN/KOTA</option>
          <option value="KODIM" <?php echo ($baphp_persediaan->titik_serah == 'KODIM')? 'selected':'';?>>KODIM/KOREM</option>
        </select>
        ...
        <?php }elseif($val['column'] == 'provinsi_penerima'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $alokasi_persediaan_pusat->nama_provinsi;?>" readonly />                   
        <?php }elseif($val['column'] == 'kabupaten_penerima'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $alokasi_persediaan_pusat->nama_kabupaten;?>" readonly />                   
        <?php }elseif($val['column'] == 'nama_barang'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $alokasi_persediaan_pusat->{$val['column']};?>" readonly />                   
        <?php }elseif($val['column'] == 'merk'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $alokasi_persediaan_pusat->{$val['column']};?>" readonly />                   
        <?php }elseif($val['column'] == 'jumlah_barang'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value=<?php echo number_format($alokasi_persediaan_pusat->jumlah_barang,0);?> readonly />                   
        <?php }elseif($val['column'] == 'nilai_barang'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value=<?php echo number_format($alokasi_persediaan_pusat->nilai_barang,0);?> readonly />                   
        <?php }elseif($val['column'] == 'harga_satuan'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value=<?php echo number_format($alokasi_persediaan_pusat->harga_satuan,0);?> readonly />                   
        ...
        <?php }elseif($val['column'] == 'pihak_penyerah'){ ?>
          <input type="text" name="nama_penyedia_pusat" id="<?php echo $val['column'];?>" readonly class="form-control" value="<?php echo $baphp_persediaan->nama_penyedia_pusat;?>" />                   
        <?php }elseif($val['column'] == 'nama_penyerah'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $baphp_persediaan->{$val['column']};?>" />                   
        ...
        <?php }elseif($val['column'] == 'alamat_penerima'){ ?>
          <textarea rows=3 name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control"><?php echo $baphp_persediaan->{$val['column']};?></textarea>
        <?php }elseif($val['column'] == 'tanggal') { ?>
          <div class="input-daterange input-group" id="datepicker">
          <input type="text" class="input-sm form-control" name="tanggal" autocomplete="off" value="<?php echo ($baphp_persediaan->tanggal > '1900-01-01')? date('d-m-Y', strtotime($baphp_persediaan->tanggal)):''; ?>" />
          <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
          </div>
        <?php }elseif($val['column'] == 'tanggal_bart') { ?>
          <div class="input-daterange input-group" id="datepicker">
          <input type="text" class="input-sm form-control" name="<?php echo $val['column'];?>" autocomplete="off" value="<?php echo ($baphp_persediaan->{$val['column']} > '1900-01-01')? date('d-m-Y', strtotime($baphp_persediaan->{$val['column']})):''; ?>" />
          <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
          </div>
        <?php }else{ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $baphp_persediaan->{$val['column']} ?>" />
      ...
      <div class="col_full nobottommargin">
        <!-- <a href="<?php echo base_url('Baphp_persediaan/index?id_alokasi_persediaan=').$alokasi_persediaan_pusat->id; ?>"> -->
...
<script>  
  ...
  $('#titik_serah').change(function() {
    if(this.value == 'PROVINSI'){
      $('#txt_nama_wilayah').val('<?php echo $alokasi_persediaan_pusat->nama_provinsi;?>');
      $('#txt_nama_wilayah').show();
      $('#ddl_nama_wilayah').hide();
      $('#ddlsel_nama_wilayah').prop( "disabled", true );
    }
    if(this.value == 'KABUPATEN/KOTA'){
      $('#txt_nama_wilayah').val('<?php echo $alokasi_persediaan_pusat->nama_kabupaten;?>');
      $('#txt_nama_wilayah').show();
      $('#ddl_nama_wilayah').hide();
      $('#ddlsel_nama_wilayah').prop( "disabled", true );
    }
  ...
  function LoadKabupaten()
  {
    $.ajax({
      ...
      success: function(data) {
          ...
          {
            if(data[i]["id"] == '<?php echo $baphp_persediaan->id_kabupaten_penyerah; ?>'){
              $('#id_kabupaten').append(
