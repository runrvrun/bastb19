...
<div class="col-md-12 npl npr mb20 dt-buttons">
  ...
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('KontrakPusat/AddDetail?id=').$kontrak_pusat->id; ?>">
        <img src="<?php echo base_url('assets/ico/file_icon.png'); ?>" width="50px" />
      </a><br>
      <span style="font-size:10px; font-weight: bold;">Input Data Detail Kontrak</span>
    </div>
    <?php } ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
    ...
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure to delete this detail for No Kontrak <b><i class="title"></i></b> ?
            </div>
...
<div class="modal fade" id="upload-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            <div class="modal-header">
                Upload File Untuk Detail No Kontrak <b><i class="title"></i></b>
            </div>
            <div class="modal-body">
              <div class="col_full">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <table class="table table-striped">
                    <tr>
                      <!-- <td rowspan="17">
                        <img id="prev_image" src="<?php echo base_url('upload/kontrak_pusat/bit.jpg'); ?>" width="250px" />
                      </td> -->
                      <td>No Kontrak</td>
                      <td>:</td>
                    ...
                    <tr>
                      <td>Jumlah Barang</td>
                      <td>:</td>
                      <td id="prev_jumlah_barang_detail"></td>
                    </tr>
                    <tr>
                      <td>Nilai Barang (Rp)</td>
                      <td>:</td>
                      <td id="prev_nilai_barang_detail"></td>
                    </tr>
                    <tr>
                      <td>Harga Satuan (Rp)</td>
                      <td>:</td>
                      <td id="prev_harga_satuan_detail"></td>
                    </tr>
                    <tr>
                      <td>REG/CAD</td>
                      <td>:</td>
  ...
  <div class="modal-dialog" style="color:black; width: 1000px;">
      <div class="modal-content">
          ...
          <div class="modal-body" style="width: 1000px; ">
            ...
            <div class="row">
                <div class="col-md-3">
                    <input class="form-check-input" name="show" type="checkbox" value="8" id="chkNoAdendum1" checked>
                    <label class="form-check-label" for="chkNoAdendum1">No Adendum 1</label>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <input class="form-check-input" name="show" type="checkbox" value="12" id="chkNoAdendum2" checked>
                    <label class="form-check-label" for="chkNoAdendum2">No Adendum 2</label>
                </div>
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("KontrakPusat/UploadFileDetail"); ?>',
    ...
    init: function() {
      ...
      this.on("sendingmultiple", function(data, xhr, formData) {
          formData.append("id_kontrak_detail", jQuery("#id_row").val());
      });
    },
    success: function (file, response) {
          ...
          // }
          // alert(response);
          window.location="<?php echo base_url('KontrakPusat/ShowDetail?id='.$kontrak_pusat->id); ?>";
    },
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("KontrakPusat/AjaxGetAllDataDetail"); ?>',
        "data": {
    ...
    columns: [
        { data: "nama_provinsi" },
        { data: "nama_kabupaten" },
        { data: "jumlah_barang_detail" },
        { data: "nilai_barang_detail" },
        { data: "harga_satuan_detail" },
        { data: "regcad" },
        { data: "dinas" },
        { data: "no_adendum_1" },
  ...
  function showUploadedFiles(id_kontrak_detail)
  {
    $.ajax({
      url: "<?php echo base_url('KontrakPusat/GetKontrakDetail'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id_kontrak_detail : id_kontrak_detail},
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='../../upload/kontrak_pusat_detail/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
            content += "<td><a class='btn btn-s btn-danger' onclick='removeImage("+id_kontrak_detail+", "+i+")'><i class='glyphicon glyphicon-trash'></i></a></td>";
            content += "</tr>";
          }
  ...
  function removeImage(id_kontrak_detail, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('KontrakPusat/RemoveFileDetail'); ?>",
        dataType: 'JSON',
        type: 'GET',
        data: {id_kontrak_detail : id_kontrak_detail, urutanfile: urutan},
        success: function(data) {
  ...
  function LoadData(id_kontrak_detail)
  {
    $.ajax({
      url: "<?php echo base_url('KontrakPusat/GetKontrakDetail'); ?>",
      dataType: 'JSON',
      ...
      success: function(data) {
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'pdf' || file_format == 'PDF'){
              ...
              content += "<div class='mySlides'><div class='numbertext'> "+(i+1)+" / "+obj.length+" </div><img id='zoom_"+i+"' src='../../upload/kontrak_pusat_detail/"+obj[i]+"' height='300' /><div class='text'>"+obj[i].substring(10)+"&nbsp;&nbsp;&nbsp;<a class='btn btn-xs btn-primary btn-sm' href='../../upload/kontrak_pusat_detail/"+obj[i]+"' download><i class='glyphicon glyphicon-save-file'></i></a></div></div>";
            }
          ...
          for(var i=0;i<obj.length;i++)
          {
            var file_format = obj[i].substr(obj[i].length - 3); 
            if(file_format == 'pdf' || file_format == 'PDF'){
              PDFObject.embed("../../upload/kontrak_pusat_detail/"+obj[i], "#embedPDF_"+i);
        ...
        $('#prev_jumlah_barang_detail').html(data['jumlah_barang_detail']);
        $('#prev_nilai_barang_detail').html(data['nilai_barang_detail']);
        ...
        $('#prev_harga_satuan_detail').html(harga_satuan);

        $('#prev_jumlah_barang_detail').number( true, 0 );
        $('#prev_nilai_barang_detail').number( true, 0 );
        $('#prev_harga_satuan_detail').number( true, 0 );
