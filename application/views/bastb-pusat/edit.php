<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bastb_pusat/update'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      ...
      <div class="col_full">
        ...
        <?php }elseif($val['column'] == 'tanggal') { ?>
          ...
          <input type="text" class="input-sm form-control" name="tanggal" value="<?php echo ($bastb_pusat->tanggal > '1900-01-01')? date('d-m-Y', strtotime($bastb_pusat->tanggal)):''; ?>" autocomplete="off" />
        ...
        <?php }elseif($val['column'] == 'provinsi_penerima'){ ?>
          <input type="hidden" name="id_provinsi_penerima" id="id_provinsi_penerima" value="<?php echo $bastb_pusat->id_provinsi_penerima;?>" />                   
          <input type="text" class="form-control" value="<?php echo $bastb_pusat->provinsi_penerima;?>" readonly />                   
        ...
        <?php }elseif($val['column'] == 'nama_barang'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $bastb_pusat->{$val['column']};?>" readonly />                   
        ...
        <?php }elseif($val['column'] == 'nilai_barang'){ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value=<?php echo number_format($bastb_pusat->nilai_barang,0);?> readonly />                   
        ...
        <?php }elseif($val['column'] == 'alamat_penyerah'){ ?>
          <textarea rows=3 name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control"><?php echo $bastb_pusat->{$val['column']};?></textarea>                   
        ...
        <?php }else{ ?>
          <input type="text" name="<?php echo $val['column'];?>" id="<?php echo $val['column'];?>" class="form-control" value="<?php echo $bastb_pusat->{$val['column']} ?>" />
        <?php } ?>
      </div>
      <?php } ?>
  ...
  function LoadKelurahan()
  {
    $.ajax({
      ...
      success: function(data) {
          ...
          for(var i=0;i<data.length;i++)
          {
            if(data[i]["id"] == '<?php echo (empty($bastb_pusat->id_kelurahan_penerima))? 0:$bastb_pusat->id_kelurahan_penerima; ?>'){
