...
<ul class="nav nav-tabs">
  <li><a href="<?php echo base_url('Rekap_kontrak_provinsi/rekap?id_kontrak_provinsi='.$kontrak_provinsi->id);?>">Rekap Data</a></li>
  <li class="active"><a href="<?php echo base_url('Rekap_kontrak_provinsi/pemanfaatan?id_kontrak_provinsi='.$kontrak_provinsi->id);?>">Pemanfaatan</a></li>
</ul>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
      "type": "POST",
        "url": '<?php echo base_url("Rekap_kontrak_provinsi/pemanfaatan_json"); ?>',
        "data": {
