...
<div id="headerKontrak" style="width:100%; text-align:center; border-style: solid; mergin-bottom: 40px">
  ...
  <span class="sisamasa">(tersisa <?php echo max(round((strtotime($kontrak_provinsi->periode_selesai) - time()) / (60 * 60 * 24)),0) ?> hari)</span></h4>
...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">    
      <a href="downloaddoc?id_kontrak_provinsi=<?php echo $kontrak_provinsi->id;?>">
      <img style="cursor: pointer;" src="<?php echo base_url('assets/ico/downloaddoc.png'); ?>" width="50px" />
      </a>
      <br>
...
<ul class="nav nav-tabs">
  <li class="active"><a href="<?php echo base_url('Rekap_kontrak_provinsi/rekap?id_kontrak_provinsi='.$kontrak_provinsi->id);?>">Rekap Data</a></li>
  <li><a href="<?php echo base_url('Rekap_kontrak_provinsi/pemanfaatan?id_kontrak_provinsi='.$kontrak_provinsi->id);?>">Pemanfaatan</a></li>
</ul>
...
<script>
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Rekap_kontrak_provinsi/rekap_json"); ?>',
        "data": {
