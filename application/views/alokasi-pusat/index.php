...
<div id="headerKontrak" style="width:100%; text-align:center; border-style: solid; mergin-bottom: 40px">
  ...
  <span class="sisamasa">(tersisa <?php echo (max(round((strtotime($kontrak_pusat->periode_selesai) - time()) / (60 * 60 * 24))+1,0)) ?> hari)</span></h4>
...
<div class="col-md-12 npl npr mb20 dt-buttons">
  ...
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Alokasi_pusat/create?id_kontrak_pusat=').$kontrak_pusat->id; ?>">
  ...
  <div style="float: right; margin-right: -30px;">
    <div class="col-sm-6" style="width: 200px; height: 100px; text-align: center; padding-top: 15px; border-right: solid; border-right-color: #efefef; ">
      ...
      <span class="sisamasa">(tersisa <?php echo $kontrak_pusat->jumlah_barang-$total_unit ?> unit)</span></h4>
    </div>
    <div class="col-sm-6" style="width: 200px; height: 100px; text-align: center; padding-top: 15px; border-right: solid; border-right-color: #efefef;">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    success: function (file, response) {      
      <?php if(isset($kontrak_pusat)){ ?>
      window.location="<?php echo base_url('Alokasi_pusat/index?id_kontrak_pusat='.$kontrak_pusat->id); ?>";
      <?php }else{ ?>
  ...
  $(document).ready(function() {
    ...
    <?php if(isset($kontrak_pusat)){?>
    //popup sisa masa
    var sisamasa = <?php echo (max(round((strtotime($kontrak_pusat->periode_selesai) - time()) / (60 * 60 * 24))+1,0)) ?>;
    if(sisamasa == 0){
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Alokasi_pusat/index_json"); ?>',
        <?php if(isset($kontrak_pusat)){ ?>
        "data": {
        ...
        if(data['nama_file'] != '' && data['nama_file'] != "null" ){
          ...
          for(var i=0;i<obj.length;i++)
          {
            ...
            if(file_format == 'PDF' || file_format == 'pdf'){
              ...
              content += "<td>"+(i+1)+"</td><td><img src='<?php echo base_url();?>/upload/alokasi_pusat/"+obj[i]+"'/></td><td>"+obj[i].substring(10)+"</td>";
            }
