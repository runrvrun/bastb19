<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Alokasi_pusat/store'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      <input type="hidden" name="id_kontrak_pusat" value="<?php echo $kontrak_pusat->id; ?>" />
      <h3>TAMBAH DATA ALOKASI KONTRAK PUSAT</h3>
      <hr>
      <div class="col_full">
