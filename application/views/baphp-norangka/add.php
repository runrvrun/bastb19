...
<div class="col_three_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" id="frmrceate" action="<?php echo base_url('Baphp_norangka/store'); ?>" style="font-color:black;">
      ...
      <div>
        <div style="float:left"><a href="<?php echo base_url('Baphp_norangka?id_baphp='.$id_baphp) ?>" class="btn btn-warning">&laquo; Kembali</a></div>
...
<script>  
  ...
  var table = $('#Table1').DataTable({
    // tampilkan norangka yang memiliki no_kontrak sama yang belum terpilih 
    // "pageLength": 10,
    // "lengthChange": true,
    "processing" : true,
    "serverSide" : true,
    ...
    "ajax": {
        ...
        <?php if(isset($baphp)){ ?>
        "data": {
           id_kontrak_pusat : '<?php echo $baphp->id_kontrak_pusat; ?>'
        },
        <?php } ?>
        "dataType": "json",
    },
