<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Bart_norangka/store'); ?>" style="font-color:black;">
      <input type="hidden" name="id_bart" value="<?php echo $id_bart;?>"/>
      ...
      <div class="col_full nobottommargin">
        <a href="<?php echo base_url('Bart_norangka/index?id_bart='.$id_bart); ?>">
