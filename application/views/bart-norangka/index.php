...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <?php if($bolehtambah) { ?>
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Bart_norangka/create?id_bart='.$bart->id); ?>">
...
<div class="modal fade" id="upload-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="color:black;">
        <div class="modal-content">
            <div class="modal-header">
                Upload File Untuk Data Bart_norangka <b><i class="title"></i></b>
            </div>
            <div class="modal-body">
              <div class="col_full">
                <label>UPLOAD FOTO/DOKUMEN Data Bart_norangka</label>
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("Bart_norangka/upload_file"); ?>',
    ...
    success: function (file, response) {      
      <?php if(isset($bart)){ ?>
      window.location="<?php echo base_url('Bart_norangka/index?id='.$bart->id); ?>";
      <?php }else{ ?>
        window.location="<?php echo base_url('Bart_norangka'); ?>";
      <?php } ?>
    }
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "buttons": [
      {
          extend: 'excel',
          <?php if(isset($bart)){ ?>         
          messageTop: 'Penyedia : <?php echo $bart->nama_penyedia_pusat; ?> | No Kontrak : <?php echo $bart->nomor; ?> | Tanggal : <?php echo date("d M Y", strtotime($bart->tanggal));?> | Nama Barang : <?php echo $bart->nama_barang ?> | Merk : <?php echo $bart->merk; ?> | Jumlah Barang : <?php echo number_format($bart->jumlah_barang, 0); ?> Unit',
          <?php } ?>
          exportOptions: {
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Bart_norangka/index_json"); ?>',
        <?php if(isset($bart)){ ?>
        "data": {
           id_bart : '<?php echo $bart->id; ?>'
        },
        <?php } ?>
        "dataType": "json",
    },
  ...
  {
    $.ajax({
      url: "<?php echo base_url('Bart_norangka/get_json'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id : id_norangka},
  ...
  function removeImage(id_norangka, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('Bart_norangka/remove_file'); ?>",
        dataType: 'JSON',
        type: 'GET',
