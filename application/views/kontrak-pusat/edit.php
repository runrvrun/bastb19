<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Kontrak_pusat/update'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;" enctype="multipart/form-data">
      ...
      <div class="col_full">
        ...
        <?php 
          foreach($penyedia_pusat as $penyedia){
            ...
            echo ($penyedia->id == $kontrak_pusat->id_penyedia_pusat)? " selected":"";
            echo ">".$penyedia->nama_penyedia_pusat."</option>";
          }
        ?>
        </select>
      </div>
