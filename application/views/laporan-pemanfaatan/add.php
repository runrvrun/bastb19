<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Laporan_pemanfaatan/store'); ?>" style="font-color:black;" enctype="multipart/form-data">
      <?php if(isset($id_bastb_pusat)){ ?>
      ...
      <?php if(isset($id_bastb_pusat)){ ?>        
        <a href="<?php echo base_url('Laporan_pemanfaatan/index?id_bastb_pusat=').$id_bastb_pusat; ?>">
      <?php } ?>
