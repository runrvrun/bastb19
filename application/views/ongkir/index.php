...
<div class="col-md-12 npl npr mb20 dt-buttons">
  <div class="col-sm-6" style="height: 120px; border: solid 1px; ">
    ...
    <div class="col-sm-3" style="padding-top: 10px; text-align: center; ">
      <a href="<?php echo base_url('Ongkir/create?id_baphp='.$baphp->id); ?>">
...
<script>
  ...
  Dropzone.options.myDropzone= {
    ...
    url: '<?php echo base_url("Ongkir/upload_file"); ?>',
    ...
    success: function (file, response) {      
      <?php if(isset($baphp)){ ?>
      window.location="<?php echo base_url('Ongkir/index?id_baphp='.$baphp->id); ?>";
      <?php }else{ ?>
        window.location="<?php echo base_url('Ongkir'); ?>";
      <?php } ?>
    }
  }
  ...
  var table = $('#Table1').DataTable({
    ...
    "ajax": {
        "type": "POST",
        "url": '<?php echo base_url("Ongkir/index_json"); ?>',
        <?php if(isset($baphp)){ ?>
        "data": {
           id_baphp : '<?php echo $baphp->id; ?>'
        },
        <?php } ?>
        "dataType": "json",
    },
  ...
  {
    $.ajax({
      url: "<?php echo base_url('Ongkir/get_json'); ?>",
      dataType: 'JSON',
      type: 'GET',
      data: {id : id_ongkir},
  ...
  function removeImage(id_ongkir, urutan)
  {
    ...
    if (r == true) {
      $.ajax({
        url: "<?php echo base_url('Ongkir/remove_file'); ?>",
        dataType: 'JSON',
        type: 'GET',
