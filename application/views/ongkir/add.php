<div class="col_two_fifth col_centered nobottommargin">
  <div class="well well-lg nobottommargin">
    <form method="post" action="<?php echo base_url('Ongkir/store'); ?>" onkeypress="return event.keyCode != 13;" style="font-color:black;">
      ...
      <div class="col_full nobottommargin">
        <a href="<?php echo base_url('Ongkir/index?id_baphp='.$id_baphp); ?>">
