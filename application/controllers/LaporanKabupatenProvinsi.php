...
class LaporanKabupatenProvinsi extends CI_Controller {
	...
	public function AjaxGetDataUnit()
	{
		...
		$totalData = $this->LaporanProvinsiModel->GetAllAjaxCountKabupaten($list_nama_barang, $list_id_provinsi);
        ...
        {            
            $posts = $this->LaporanProvinsiModel->GetAllForAjaxKabupaten($_POST['start'], $_POST['length'], $order, $dir, $filtercond, $list_nama_barang, $list_id_provinsi);
            $totalFiltered = $this->LaporanProvinsiModel->GetFilterAjaxCountKabupaten($filtercond, $list_nama_barang, $list_id_provinsi);
        }
        else {
            $search = $this->input->post('search')['value']; 

            $posts =  $this->LaporanProvinsiModel->GetSearchAjaxKabupaten($_POST['start'], $_POST['length'], $search, $order, $dir, $filtercond, $list_nama_barang, $list_id_provinsi);

            $totalFiltered = $this->LaporanProvinsiModel->GetSearchAjaxCountKabupaten($search, $filtercond, $list_nama_barang, $list_id_provinsi);
        }
