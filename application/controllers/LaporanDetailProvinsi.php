...
class LaporanDetailProvinsi extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
	        'title' => 'DETAIL',
	        'content-path' => 'PENGADAAN TP PROVINSI / LAPORAN / DETAIL',
	        'content' => $this->load->view('laporan-detail-provinsi', $param, TRUE),
		);
	...
	public function AjaxGetDataUnit()
	{
		...
		$totalData = $this->LaporanProvinsiModel->GetAllAjaxCountDetail($list_nama_barang, $list_id_provinsi, $list_id_kabupaten);
        ...
        {            
            $posts = $this->LaporanProvinsiModel->GetAllForAjaxDetail($_POST['start'], $_POST['length'], $order, $dir, $filtercond, $list_nama_barang, $list_id_provinsi, $list_id_kabupaten);
            $totalFiltered = $this->LaporanProvinsiModel->GetFilterAjaxCountDetail($filtercond, $list_nama_barang, $list_id_provinsi, $list_id_kabupaten);
        }
        else {
            $search = $this->input->post('search')['value']; 

            $posts =  $this->LaporanProvinsiModel->GetSearchAjaxDetail($_POST['start'], $_POST['length'], $search, $order, $dir, $filtercond, $list_nama_barang, $list_id_provinsi, $list_id_kabupaten);

            $totalFiltered = $this->LaporanProvinsiModel->GetSearchAjaxCountDetail($search, $filtercond, $list_nama_barang, $list_id_provinsi, $list_id_kabupaten);
        }
