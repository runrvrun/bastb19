...
class BAPSTHPCadangan extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
	        'title' => 'BAP-STHP Cadangan',
	        'content-path' => 'PENGADAAN PUSAT / BAP-STHP CADANGAN',
	...
	public function AjaxGetAllData()
	{
        ...
        if(!empty($posts))
        {
            foreach ($posts as $post)
            {
				...
				if($bolehedit)
					$tools .= "<a class='btn btn-xs btn-primary btn-sm' href='".base_url('BAPSTHPCadangan/Edit?id=').$post->id."'><i class='glyphicon glyphicon-pencil'></i></a><a class='btn btn-xs btn-info btn-sm' data-href='#' data-toggle='modal' data-record-title='".$post->no_bapsthp."' data-target='#upload-modal' data-record-id='".$post->id."'><i class='glyphicon glyphicon-open-file'></i></a>";

				if($bolehhapus)
					$tools .= "<a class='btn btn-xs btn-danger btn-sm' data-href='".base_url('BAPSTHPCadangan/doDelete?id=').$post->id."' data-toggle='modal' data-record-title='".$post->no_bapsthp."' data-target='#confirm-delete'><i class='glyphicon glyphicon-trash'></i></a>";
	...
	public function Add()
	{
		...
		$data = array(
	        'title' => 'INPUT LAPORAN BAP-STHP CADANGAN',
	        'content-path' => 'PEGADAAN PUSAT / BAP-STHP CADANGAN / TAMBAH DATA',
	...
	public function Edit()
	{
		...
		$this->load->library('parser');
		$data = array(
	        'title' => 'UBAH LAPORAN BAP-STHP CADANGAN',
	        'content-path' => 'PEGADAAN PUSAT / BAP-STHP CADANGAN / UBAH DATA',
